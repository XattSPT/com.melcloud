...
class MelCloudDriverAC extends MelCloudDriverMixin {
  onInit() {
    ...
    this.HorizontalSwingCondition = this.homey.flow.getConditionCard('Horizontal_Swing_Condition');
    ...
    // Action flowcards
    this.ThermostatModeAction = this.homey.flow.getActionCard('Full_Thermostat_Action');
    ...
    this.FanSpeedAction = this.homey.flow.getActionCard('Fan_Speed_Action');
    ...
    this.VerticalAction = this.homey.flow.getActionCard('Vertical_Swing_Action');
    ...
    this.HorizontalAction = this.homey.flow.getActionCard('Horizontal_Swing_Action');
